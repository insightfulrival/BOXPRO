    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link
          ...
          className="bg-dark-lighter border border-foreground/10 rounded-xl p-6 hover:border-primary/30 transition-colors group"
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-foreground font-medium">{t('addProject')}</p>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-foreground font-medium">{t('uploadPhotos')}</p>
